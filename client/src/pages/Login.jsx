          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Link to="/forgot-password" className="text-sm text-dark-blue hover:text-mid-blue transition-colors font-medium">
                  Forgot password?
                </Link>
              </div>
              ...
              <p className="text-center text-sm text-gray-500">
                ...
                <Link to="/register" className="font-medium text-dark-blue hover:text-mid-blue transition-colors">
                  Sign up
                </Link>
              </p>
