...
export const getCourseByTier = async (req: any, res: Response) => {
  try {
...
export const getSprint = async (req: any, res: Response) => {
  try {
    const { id } = req.params;
...
export const markSprintComplete = async (req: any, res: Response) => {
  try {
